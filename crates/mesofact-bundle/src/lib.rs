...
mod assemble;
pub use assemble::{
    assemble_bundle, assemble_bundle_from_files, assemble_self_bundle, assemble_self_bundle_with,
    assemble_vanilla_bundle, collect_component_files, collect_dir, BundleFile, ServeBinSource,
};
